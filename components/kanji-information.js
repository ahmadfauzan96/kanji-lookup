      ...
      <div className="card-body">
        <ul className="list-group list-group-flush">
          ...
          {unihanCJKUnifiedVariant && (
            <li className="list-group-item">
              Unihan CJK Unified Variant : {unihanCJKUnifiedVariant}
            </li>
          )}
          <li className="list-group-item">
            ...
            <ul className="list-group">
              <li className="list-group-item">
                From the API doc : “A relative frequency ranking from an analysis of Mainichi
                Shinbun newspaper articles. The 2,501 most-used characters received a ranking.”
                Kanji of rank 1 is the most frequent, while one of rank 2,501 is the least frequent.
                If a kanji is not ranked, it means that it is not among the 2,501 most-used
                characters in the{" "}
          ...
          <li className="list-group-item">
            Note
            {notes.length > 1 ||
            (notes.length === 1 && kanjiIsOfficialVariantAndMissingFromJISX0208)
              ? "s"
              : ""}
            <ul className="list-group">
              {kanjiIsOfficialVariantAndMissingFromJISX0208 && (
                <li className="list-group-item">
                  This kanji is one of the four official jōyō variant of the kanjis missing from JIS
                  X 0208. The JIS X 0208 variant for this kanji is {theJISX0208KanjiVariant(kanji)}.
                </li>
              )}
              {notes.length > 0 ||
              (notes.length === 0 && kanjiIsOfficialVariantAndMissingFromJISX0208)
                ? notes.map(note => (
                ...
                : !kanjiIsOfficialVariantAndMissingFromJISX0208 && (
                    <li className="list-group-item">
                      There are no notes available for this kanji.
                    </li>
                  )}
            </ul>
          </li>
